...
const TransportationUI = () => {
  ...
  const navIcons = {
    ...
    Transportation: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="#009DE0"><path d="M19 8l-3.92 0c-.11-.27-.19-.54-.28-.82l1.75-3.84c.07-.15.1-.32.1-.5 0-.55-.45-1-1-1H8.5c-.55 0-1 .45-1 1 0 .18.03.35.1.5l1.75 3.84c-.09.28-.17.55-.28.82L5 8 5 19h14L19 8zM6 18H6V9H5v9H6zm12 0H12V9h6v9H18z"/></svg>,
      ...
      <div className={`bg-gray-200 flex flex-col box-border ${isMobile ? 'basis-full py-6 px-5' : 'basis-3/5 py-8 px-10'}`}>
        <div className={`flex justify-center mb-7 gap-15 ${isMobile ? 'flex-wrap' : 'flex-nowrap'}`}>
          ...
          <Link to="/income" className="text-decoration-none">
            <div className="p-0 mr-[15px] cursor-pointer text-gray-500 text-sm flex flex-col items-center">
              <div className="bg-white rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2">{navIcons.Income}</div>
          ...
          <Link to="/transportation" className="text-decoration-none">
            <div className="p-0 mr-[15px] text-black flex flex-col items-center">
              <div className="bg-gray-200 rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2">{navIcons.Transportation}</div>
              <span className="text-black text-xs text-center">Transportation</span>
            </div>
          </Link>
