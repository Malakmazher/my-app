...
const HousingAndFoodUI = () => {
  ...
  const navIcons = {
    ...
    Housing: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="#009DE0"><path d="M20 7L9 0 2 4v16h20V7z"/></svg>,
        ...
        <div className={`flex justify-center mb-7 gap-15 ${isMobile ? 'flex-wrap' : 'flex-nowrap'}`}>
          ...
          <Link to="/housing" className="text-decoration-none">
            <div className="p-0 mr-[15px] text-black flex flex-col items-center">
              <div className="bg-gray-200 rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2">{navIcons.Housing}</div>
