...
const AccountsUI = () => {
  ...
  const navIcons = {
    ...
    Accounts: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="#009DE0"><path d="M12 2a5 5 0 100 10 5 5 0 000-10zM4 21v-2a5 5 0 015-5h6a5 5 0 015 5v2H4z"/></svg>,
    ...
    <div className={`flex w-full max-w-full box-border justify-start items-stretch ${isMobile ? 'flex-col' : 'flex-row'} h-screen`}>
      ...
      <div className={`bg-gray-200 flex flex-col box-border ${isMobile ? 'basis-full py-6 px-5' : 'basis-3/5 py-8 px-10'}`}>
        <div className={`flex justify-center mb-7 gap-15 ${isMobile ? 'flex-wrap' : 'flex-nowrap'}`}>
          ...
          <Link to="/accounts" className="text-decoration-none">
            <div className="p-0 mr-[15px] text-black flex flex-col items-center">
              <div className="bg-gray-200 rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2">{navIcons.Accounts}</div>
              <span className="text-black text-xs text-center">Accounts</span>
            </div>
          </Link>
        ...
        <div className="flex justify-between items-center mb-5">
            <div className="text-[42px] font-bold text-gray-800">Accounts</div>
        ...
        <div className="mb-8">
          <div className="flex gap-[18px]">
            <div className="mb-0 flex flex-col flex-1 min-w-0">
              <label className="text-sm mb-[7px] text-gray-600">Account Name</label>
