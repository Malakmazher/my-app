...
const IncomeUI = () => {
  ...
  const navIcons = {
    ...
    Accounts: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="#777"><path d="M12 2a5 5 0 100 10 5 5 0 000-10zM4 21v-2a5 5 0 015-5h6a5 5 0 015 5v2H4z"/></svg>,
    Income: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="#009DE0"><path d="M2 20h20v-1H2v1zm4-3h12v-1H6v1zM2 10h20V9H2v1zm4-3h12V6H6v1zM2 3v1h20V3H2z"/></svg>,
    ...
    <div className={`flex w-full max-w-full box-border justify-start items-stretch ${isMobile ? 'flex-col' : 'flex-row'} h-screen`}>
      <div className={`bg-sky-500 text-white box-border flex items-center justify-center ${isMobile ? 'basis-full py-7 px-5' : 'basis-2/5 py-10 px-10'}`}>
        <div className="p-0 max-w-[410px]">
          <div className="text-[34px] font-semibold mb-5 leading-[1.3]">Okay, enter your monthly paychecks and other regular income</div>
          <div className="text-base text-gray-300 leading-[1.4]">All-in-one solution to for your business in the state. <br />Form new company from scratch or onboard your existing Company</div>
        </div>
      </div>
        ...
        <div className={`flex justify-center mb-7 gap-15 ${isMobile ? 'flex-wrap' : 'flex-nowrap'}`}>
          <Link to="/welcome" className="text-decoration-none">
            <div className="p-0 mr-[15px] cursor-pointer text-gray-500 text-sm flex flex-col items-center">
              <div className="bg-white rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2"> {navIcons.Welcome}  </div>
              <span className="text-gray-500 text-xs text-center">Welcome</span>
            </div>
          </Link>
          <Link to="/accounts" className="text-decoration-none">
            <div className="p-0 mr-[15px] cursor-pointer text-gray-500 text-sm flex flex-col items-center">
              <div className="bg-white rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2"> {navIcons.Accounts} </div>
          ...
          <Link to="/income" className="text-decoration-none">
            <div className="p-0 mr-[15px] text-black flex flex-col items-center">
              <div className="bg-gray-200 rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2">{navIcons.Income}</div>
              <span className="text-black text-xs text-center">Income</span>
            </div>
          </Link>
          <Link to="/housing" className="text-decoration-none">
            <div className="p-0 mr-[15px] cursor-pointer text-gray-500 text-sm flex flex-col items-center">
              <div className="bg-white rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2"> {navIcons.Housing} </div>
              <span className="text-gray-500 text-xs text-center">Housing</span>
            </div>
          </Link>
          <Link to="/transportation" className="text-decoration-none">
            <div className="p-0 mr-[15px] cursor-pointer text-gray-500 text-sm flex flex-col items-center">
              <div className="bg-white rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2"> {navIcons.Transportation} </div>
              <span className="text-gray-500 text-xs text-center">Transportation</span>
            </div>
          </Link>
          <Link to="/lifestyle" className="text-decoration-none">
            <div className="p-0 mr-[15px] cursor-pointer text-gray-500 text-sm flex flex-col items-center">
              <div className="bg-white rounded-full w-[30px] h-[30px] flex justify-center items-center mb-2"> {navIcons.Lifestyle} </div>
          ...
          <div className="bg-white py-3.5 px-5 rounded-md mb-2.5 flex justify-between items-center border border-gray-300">
            ...
            <div className="flex items-center gap-1">
              ...
              <button className="bg-transparent border-none cursor-pointer p-1.5 ml-4">
                <img src="data:image/png;base64," alt="delete" className="w-3 h-3 opacity-60" />
              </button>
            </div>
          </div>
          <div className="bg-white py-3.5 px-5 rounded-md mb-2.5 flex justify-between items-center border border-gray-300">
